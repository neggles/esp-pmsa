...
JLCFAB_IGNORE = H1,H2,H3,H4,M1,U1,LOGO1
...
build/esp-pmsa.kicad_pcb: esp-pmsa/esp-pmsa.kicad_pcb build
	kikit panelize extractboard -s 150 75 40 50 $< $@
...
build/web/index.html: build/web $(BOARDSFILES)
	kikit present boardpage \
		-d README.md \
		--name "ESP8266 PMSx Sensor Board" \
		-b "ESP8266 PMSx Sensor Board" "Single board" build/esp-pmsa.kicad_pcb  \
		-b "ESP8266 PMSx Sensor Board" "Panel of 2" build/esp-pmsa-panel.kicad_pcb  \
